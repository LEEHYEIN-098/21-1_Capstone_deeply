...
function signal(url, onStream, onError, onClose, onMessage, onDataChannel, onDataChannelMsg) {
    if ("WebSocket" in window) {
        ...
        ws.onopen = function () {
            ...
            pc.ondatachannel = function (event) {
                console.log("a datachannel has been created");
                ...
                event.channel.onmessage = function (event) {
                    onDataChannelMsg(event.data);
                };

                event.channel.onclose = function () {
                    console.log("the datachannel is closed");
                };
            };
